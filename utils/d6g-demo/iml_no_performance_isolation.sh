...
curl -F file=@policies/demo_pol_1_no_perf_isolation_ns-slice_1.yml http://localhost:5000/iml/update-policy

echo "Applying no performance isolation policy to network slice 2..."
curl -F file=@policies/demo_pol_1_no_perf_isolation_ns-slice_2.yml http://localhost:5000/iml/update-policy
