...
if __name__ == "__main__":
    ...
    rospy.init_node("cmd_vel_to_twiststamped", anonymous=True)
    ...
    rospy.loginfo("cmd_vel_to_twiststamped node started. Translating {} to {}".format(args.input_topic, args.output_topic))
    rospy.spin()
